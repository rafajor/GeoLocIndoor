...
#SPIF1       = "UDP", "192.168.1.53", 1401
#SPIF2       = "UDP", "192.168.1.54", 1401

SPIF1       = "UDP", str(sys.argv[1]), 1401
SPIF2       = "UDP", str(sys.argv[2]), 1401
...
PENDIENTE=0.984772244208425
ORDENADA=-152.016687912411
...
#        print("%7.5f" % (t2*TSTAMP_DIST))
#        print (t2)
        res=(t2*TSTAMP_DIST)
        res=res*PENDIENTE+ORDENADA
        ress.append(res)
        errors = 0
        if (len(ress)>29):
#            print (len(ress))
